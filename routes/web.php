...
Route::middleware('web')->group(function () {
    ...
    Route::get(
        config('singpass-myinfo.authentication_endpoint_url'),
        config('singpass-myinfo.authentication_endpoint_controller')
    )->name('singpass.login');

    // this is the route that will be called when Singpass redirects back after authentication
    Route::get(
        config('singpass-myinfo.callback_endpoint_url'),
    ...
    Route::get(
        config('singpass-myinfo.jwks_endpoint_url'),
